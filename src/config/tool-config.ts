...
export const toolDescriptions = {
    ...
    get_page_content: "Extracts and formats the current page's content into a well-structured markdown format. Includes the page title, meta description, and main content with proper heading hierarchy, links, and images. Handles dynamic content by waiting for JavaScript execution. Automatically cleans and formats the text for readability, preserving semantic structure while removing unnecessary markup.",
